...
public class ScanMaltaScraper extends Scraper {
    ...
    public List<Product> searchByBestSellers(int numProducts) throws InterruptedException {
        this.navigateToMenuItem("Best Sellers");
        return getProductsFromPage(numProducts);
    }

    public List<Product> searchByLatestProducts(int numProducts) throws InterruptedException {
        this.navigateToMenuItem("Latest Products");
        return getProductsFromPage(numProducts);
    }

    @Override
    protected Product extractProductInfo(WebElement elem) {
        ...
        product.setPriceInEuros(Long.parseLong(priceElem.getText().replaceAll("[^0-9]", "")) / 100);
    ...
    private void navigateToMenuItem(String item) throws InterruptedException {
        this.navigateToHomePage();
